...
### Chart B
Scatterplot of n and hour of day they were ordered at within produce department, with different colors for different aisles
```{r chart 2}
instacart %>% 
...
### Chart C
Boxplot of items within top 10 departments comparing their add to cart order
```{r chart 3}
top_dep =
  instacart %>% 
